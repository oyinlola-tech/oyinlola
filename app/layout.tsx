  ...
  return (
    ...
    >
      ...
      <body className="grain antialiased">
        ...
        <Footer />
        {/* Vercel Analytics and Speed Insights. Both mount after hydration and
            inject their own script from Vercel's domain, so neither blocks
            first paint. They no-op outside a Vercel deployment, which is why
            they are safe to leave mounted in local development. */}
        <Analytics />
        <SpeedInsights />
      </body>
    </html>
